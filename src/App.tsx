...
function App() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <a className="brand" href="#top" aria-label="Treasury Intelligence ana sayfa"><span className="brand-mark"><i /><i /><i /></span><span>Treasury<strong>Intelligence</strong></span></a>
      <nav aria-label="Ana navigasyon"><a className="active" href="#top"><Icon name="grid" /> Cockpit</a><a href="#importer"><Icon name="upload" /> Data Importer</a><a href="#forecast"><Icon name="pulse" /> Forecast & Stress</a><a href="#gap-drivers"><Icon name="calendar" /> Gap Drivers</a><a href="#what-changed"><Icon name="changes" /> What Changed</a></nav>
